...
const handleGameOver = () => {
    ...
    backgroundSound.pause(); // Pause background music
    ...
    changeFoodPosition();
    backgroundSound.pause(); // Resume background music
    setIntervalValid = setInterval(initGame, 125); // Restart the game loop
  };
